...
export function initShoes():Map<string,Map<string,Product>>{
    ...
    const p1 = createProduct("Air Jordan 1 Low","Nike SB","Ashen Slate",GENERALCOLOR.BLUE,1249,"https://cdn.restocks.net/cdn-cgi/image/width=1000/storage/images/products/553558-414/1.png","https://cdn.restocks.net/cdn-cgi/image/width=1000/storage/images/products/553558-414/2.png");
