...
const Nav = () => {
  ...
  return (
    <div className='w-screen  bg-stone-200  h-24 items-center flex text-zinc-800 font-bold'>
      <video onClick={homeButtonHandler} src={'media/logo.mp4'} muted playsInline autoPlay loop className='hover:cursor-pointer h-24 utmd:mx-auto md:left-0 video mix-blend-darken'/>
      ...
      <ul id="navLinks" className='flex utmd:hidden gap-8 mx-auto'>
        ...
        <div className='absolute utxs:hidden right-0 mx-4 flex gap-2'>
