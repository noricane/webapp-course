...
const News = () => {
  ...
  return (
    <div className="min-h-[65vh] max-h-[200vh] flex-col flex gap-4 bg-stone-900">
      ...
      <section className="text-center h-80% mb-4  rounded-lg text-stone-100 flex flex-col justify-center items-center gap-2 utsm:mx-2 max-w-[40rem] mx-auto bg-stone-700 p-8">
