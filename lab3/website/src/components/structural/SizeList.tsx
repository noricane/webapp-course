...
const SizeList = ({items}:{items:{size:number,amount:number}[]}) => {
  ...
  return (
    ...
    <div className={`${isOpen ? 'h-0 w-36 opacity-0' : 'h-48 w-56'} py-3 px-2 flex flex-col gap-3 font-bold scrollbar-hide overflow-y-scroll overflow-x-hidden rounded-md transition-all bg-stone-50 `}>
